...
def get_transaction_history(account_id: str, limit: int = 50):
    ...
    for t in transactions:
        is_sender = t["from_account_id"] == account_id
        response_transactions.append(
            {
                ...
                "amount": t["amount_paid"] if is_sender else t["amount_received"],
...
def get_kyc_details(account_id: str):
    ...
    account = account_repo.get_by_id(account_id) or {}
    ...
    return KYCResponse(
        ...
        account_open_date=account.get("account_open_date"),
