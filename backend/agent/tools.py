...
USE_BACKEND_API = True  # Use backend API for live investigations
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return {
                ...
                "summary": {
                    "total_sent": sum(t.get("amount", 0) for t in data["transactions"] if t.get("from_account") == account_id),
                    "total_received": sum(t.get("amount", 0) for t in data["transactions"] if t.get("to_account") == account_id),
